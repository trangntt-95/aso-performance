  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-3 text-sm leading-relaxed">
        {primaryCause && (
          <div>
            <div className="text-[11px] uppercase tracking-wide text-slate-500 mb-0.5">Primary cause</div>
            <div className="font-medium">{primaryCause}</div>
          </div>
        )}
        {causeDetails && (
          <div className="text-slate-700 whitespace-pre-line text-[13px]">{causeDetails}</div>
        )}
        {narrative ? (
