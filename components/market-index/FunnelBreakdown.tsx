          ...
          <table className="w-full text-xs">
            ...
            <tbody>
              <tr className="border-t">
                ...
                <td className="px-2 py-2 text-right text-gray-400">{formatNumber(organic.P.users, { compact: true })}</td>
                <td className={cn('px-2 py-2 text-right', highlightCls(usersTone.paid))}>{formatNumber(paid.L.users, { compact: true })}</td>
                <td className="px-2 py-2 text-right text-gray-400">{formatNumber(paid.P.users, { compact: true })}</td>
                <td className={cn('px-2 py-2 text-right font-medium', highlightCls(usersTone.total))}>{formatNumber(total.L.users, { compact: true })}</td>
                <td className="px-2 py-2 text-right text-gray-400">{formatNumber(total.P.users, { compact: true })}</td>
              </tr>
              <tr className="border-t">
                <td className="px-3 py-2 font-medium">GetApp</td>
                <td className={cn('px-2 py-2 text-right', highlightCls(getAppTone.org))}>{formatNumber(organic.L.getapp, { compact: true })}</td>
                <td className="px-2 py-2 text-right text-gray-400">{formatNumber(organic.P.getapp, { compact: true })}</td>
                <td className={cn('px-2 py-2 text-right', highlightCls(getAppTone.paid))}>{formatNumber(paid.L.getapp, { compact: true })}</td>
                <td className="px-2 py-2 text-right text-gray-400">{formatNumber(paid.P.getapp, { compact: true })}</td>
                ...
                <td className="px-2 py-2 text-right text-gray-400">{formatNumber(total.P.getapp, { compact: true })}</td>
              </tr>
              <tr className="border-t">
                ...
                <td className="px-2 py-2 text-right text-gray-400">{formatPercent(organic.P.cr)}</td>
                <td className={cn('px-2 py-2 text-right', highlightCls(crTone.paid))}>{formatPercent(paid.L.cr)}</td>
                <td className="px-2 py-2 text-right text-gray-400">{formatPercent(paid.P.cr)}</td>
              ...
              <tr className="border-t">
                ...
                <td className="px-2 py-2 text-right text-gray-400">{formatPos(organic.P.pos)}</td>
                ...
                <td className="px-2 py-2 text-right text-gray-400">{formatPos(paid.P.pos)}</td>
                <td className="px-2 py-2 text-right text-gray-300">—</td>
                <td className="px-2 py-2 text-right text-gray-300">—</td>
              </tr>
            </tbody>
